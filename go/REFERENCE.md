# Peremen Golang SDK Reference

Complete API reference for the Peremen Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PeremenSDK`
...
#### `Authentication(data map[string]any) PeremenEntity`
