...
type Args struct {
	Entity string         `json:"entity" jsonschema:"authentication"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PeremenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "peremen_list",
		Description: "List records from Peremen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "peremen_load",
		Description: "Load a single record from Peremen. " +
...
func runOp(client *sdk.PeremenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PeremenSDK, name string) (sdk.PeremenEntity, error) {
