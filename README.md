...
Peremen API client, generated from the OpenAPI spec.

The Peremen API enables integration with the peremen.app browser extension, offering a seamless connection and secure access to Russian services.

Learn more about Peremen API at [github.com/l0v3m0n3y/peremen](https://github.com/l0v3m0n3y/peremen).

This is an unofficial SDK for the Peremen public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
```bash
cd go-mcp && go build -o peremen-mcp .
```
...
```json
{
  "mcpServers": {
    "peremen": {
      "command": "/abs/path/to/peremen-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Authentication** | The Authentication entity (create). | `/premium/user-email-verification` |
...
```go
import sdk "github.com/voxgig-sdk/peremen-sdk/go"
...
Generated from the Peremen API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
