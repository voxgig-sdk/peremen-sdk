...
|---|---|---|
| `ts/` | @voxgig-sdk/peremen-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/peremen-sdk \
      --repository voxgig-sdk/peremen-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/peremen-sdk` shows it, and
`npm trust revoke @voxgig-sdk/peremen-sdk --id=<id>` removes it.
