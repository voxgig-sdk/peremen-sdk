...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = PeremenOmni.make_runner(TEST_JSON_FILE, PeremenSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : PeremenOmni.errify(err)
    end
