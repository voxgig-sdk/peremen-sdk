...
// Peremen SDK utility: fetcher

class PeremenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PeremenSDK/1.0)';
    ...
    public static function call(PeremenContext $ctx, string $fullurl, array $fetchdef): array
    {
