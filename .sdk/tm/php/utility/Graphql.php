...
class PeremenGraphql
{
    ...
    // equivalent.
    public static function body(PeremenContext $ctx): mixed
    {
    ...
    public static function errors(PeremenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
