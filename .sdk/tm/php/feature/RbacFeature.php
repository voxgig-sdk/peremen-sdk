...
class PeremenRbacFeature extends PeremenBaseFeature
{
    ...
    private function _required(PeremenContext $ctx): ?string
    {
    ...
    private function _reject(PeremenContext $ctx, string $required): void
    {
    ...
    private function _track(PeremenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
