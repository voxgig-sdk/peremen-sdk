...
class PeremenCacheFeature extends PeremenBaseFeature
{
    ...
    private function _through(PeremenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
