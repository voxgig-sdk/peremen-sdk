...
class PeremenProxyFeature extends PeremenBaseFeature
{
    ...
    public function init(PeremenContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PeremenContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
