...
class PeremenNetsimFeature extends PeremenBaseFeature
{
    ...
    private function _simulate(PeremenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PeremenContext $ctx, array $applied): void
    {
        $client = $this->client;
