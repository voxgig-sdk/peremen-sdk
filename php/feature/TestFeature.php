...
// Peremen SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PeremenTestFeature extends PeremenBaseFeature
{
    ...
    public function init(PeremenContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PeremenContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PeremenContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PeremenContext $ctx, $op, $args): array
    {
