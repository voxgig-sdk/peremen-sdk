...
class PeremenRatelimitFeature extends PeremenBaseFeature
{
    ...
    private function _acquire(PeremenContext $ctx): void
    {
    ...
    private function _track(PeremenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
