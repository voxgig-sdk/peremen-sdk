...
// Peremen SDK clienttrack feature
...
class PeremenClienttrackFeature extends PeremenBaseFeature
{
    ...
    public function PostConstruct(PeremenContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Peremen-SDK';
