...
class PeremenTimeoutFeature extends PeremenBaseFeature
{
    ...
    private function _with_timeout(PeremenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PeremenContext $_ctx, float $ms): void
    {
        $client = $this->client;
