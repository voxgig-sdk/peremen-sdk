...
class PeremenStreamingFeature extends PeremenBaseFeature
{
    ...
    private function _iterate(PeremenResult $result): \Generator
    {
    ...
    private function _streamable(PeremenContext $ctx): bool
    {
