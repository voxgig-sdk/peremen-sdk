...
// Peremen SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PeremenMakeRequest
{
    public static function call(PeremenContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PeremenResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PeremenResponse($fetched);
        } else {
