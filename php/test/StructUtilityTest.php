...
// Peremen SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PeremenOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PeremenOmni::structfix($now, Struct::undef()))
                        !== json_encode(PeremenOmni::structfix($val, Struct::undef()))) {
