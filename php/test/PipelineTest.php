...
require_once __DIR__ . '/../peremen_sdk.php';
...
{
    private static function utility(): PeremenUtility
    {
        return new PeremenUtility();
    }
    ...
    private static function ctx(array $over = []): PeremenContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PeremenContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PeremenOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PeremenError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PeremenOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PeremenMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PeremenOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PeremenMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PeremenOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PeremenMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PeremenSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PeremenMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PeremenResponse([]),
            'result' => new PeremenResult([]),
        ]);
        [, $err] = PeremenMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PeremenSpec([]),
            'response' => null,
            'result' => new PeremenResult([]),
        ]);
        [, $err] = PeremenMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PeremenSpec(['step' => 's']),
            'response' => new PeremenResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PeremenResult([]),
        ]);
        [, $err] = PeremenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PeremenSpec(['step' => 's']),
            'response' => new PeremenResponse(self::resp(200, ['v' => 1])),
            'result' => new PeremenResult([]),
        ]);
        [, $err] = PeremenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PeremenSpec(['step' => 's']),
            'response' => new PeremenResponse(self::resp(200, ['v' => 2])),
            'result' => new PeremenResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PeremenMakeResponse::call($ctx);
    ...
    {
        $preset = new PeremenResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PeremenSpec([]),
            'response' => new PeremenResponse([]),
            'result' => new PeremenResult([]),
        ...
        [$got, $err] = PeremenMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PeremenResult([])]);
        [, $err] = PeremenMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PeremenSpec([]), 'result' => null]);
        [, $err] = PeremenMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PeremenSpec(['step' => 's']),
            'result' => new PeremenResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PeremenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PeremenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PeremenSpec(['step' => 's']),
            'result' => new PeremenResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PeremenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PeremenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PeremenResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PeremenSpec([]),
            'result' => new PeremenResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PeremenMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PeremenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PeremenError('boom', 'boom');
        $utility->fetcher = function (PeremenContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PeremenSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PeremenMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PeremenContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PeremenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PeremenResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PeremenContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PeremenSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PeremenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PeremenResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PeremenSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PeremenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PeremenMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PeremenMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PeremenResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PeremenDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PeremenResult(['ok' => false])]);
        $this->expectException(PeremenError::class);
        PeremenDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PeremenResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PeremenMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PeremenMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PeremenBaseFeature();
        $b = new PeremenBaseFeature();
        PeremenFeatureAdd::call($ctx, $a);
        PeremenFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PeremenBaseFeature
    {
        $f = new PeremenBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PeremenFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PeremenContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PeremenSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PeremenPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PeremenResponse(['headers' => null]),
            'result' => new PeremenResult([]),
        ]);
        PeremenResultHeaders::call($ctx);
