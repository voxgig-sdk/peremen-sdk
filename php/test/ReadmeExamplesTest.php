...
// Peremen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PeremenSDK::test)
...
{
    private const SDK_CLASS = 'PeremenSDK';
    ...
    private const SDK_BASE = 'peremen_sdk';
