...
class PeremenTestRunner
{
    ...
    {
        $live = self::getenv('PEREMEN_TEST_LIVE');
        $override = self::getenv('PEREMEN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PEREMEN_TEST_EXPLAIN');
...
class_alias('PeremenTestRunner', 'Runner');
class_alias('PeremenHelpers', 'Helpers');
