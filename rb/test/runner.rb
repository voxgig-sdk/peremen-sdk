...
module PeremenTestRunner
  ...
  def self.env_override(m)
    live = getenv("PEREMEN_TEST_LIVE")
    override = getenv("PEREMEN_TEST_OVERRIDE")
    ...
    explain = getenv("PEREMEN_TEST_EXPLAIN")
    m["PEREMEN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PeremenTestRunner
Helpers = PeremenHelpers
Vs = VoxgigStruct
