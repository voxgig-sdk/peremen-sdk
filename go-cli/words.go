...
func registerSDKWords(r *eng.Registry, client *sdk.PeremenSDK) {
...
func runOp(client *sdk.PeremenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
