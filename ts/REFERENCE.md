# Peremen TypeScript SDK Reference

Complete API reference for the Peremen TypeScript SDK.
...
#### `PeremenSDK.test(testopts?, sdkopts?)`
...
**Returns:** `PeremenSDK` instance in test mode.
...
Return the parent `PeremenSDK` instance.
