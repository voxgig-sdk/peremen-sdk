# Peremen TypeScript SDK



The TypeScript SDK for the Peremen API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Authentication()` — each with a small set of operations (`create`)
...
- Releases: [https://github.com/voxgig-sdk/peremen-sdk/releases](https://github.com/voxgig-sdk/peremen-sdk/releases)
...
```ts
try {
  const authentication = await client.Authentication().create({ email: "example", message: "example", success: true })
...
await entity.create({ email: 'example_email', message: 'example_message', success: true })
...
| `tester(testopts?, sdkopts?)` | `PeremenSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PeremenSDK.test(testopts?, sdkopts?)` | `PeremenSDK` | Create a test-mode client. |
...
| `client` | `client(): PeremenSDK` | Return the parent SDK client. |
...
await authentication.create({ email: "example", message: "example", success: true })
