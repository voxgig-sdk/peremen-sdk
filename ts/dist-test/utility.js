...
function envOverride(m) {
    if ('TRUE' === process.env.PEREMEN_TEST_LIVE ||
        'TRUE' === process.env.PEREMEN_TEST_OVERRIDE) {
    ...
    m.PEREMEN_TEST_EXPLAIN = process.env.PEREMEN_TEST_EXPLAIN || m.PEREMEN_TEST_EXPLAIN;
    return m;
}
