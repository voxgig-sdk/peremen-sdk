# Peremen SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PeremenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PeremenSDK(...) and PeremenSDK.test(...) become
#      PeremenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "peremen_sdk"
_SDK_CLASS = "PeremenSDK"
