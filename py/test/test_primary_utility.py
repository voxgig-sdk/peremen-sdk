...
from peremen_sdk.utility.voxgig_struct import voxgig_struct as vs
from peremen_sdk import PeremenSDK
from peremen_sdk.core.spec import PeremenSpec
from peremen_sdk.core.result import PeremenResult
from peremen_sdk.core.response import PeremenResponse
from peremen_sdk.core.operation import PeremenOperation
from peremen_sdk.core.error import PeremenError
from peremen_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PeremenSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PeremenSDK.test(None, None)
        ...
        class TestInitFeature(PeremenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PeremenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PeremenSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PeremenSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PeremenSDK.test(None, setup_opts)
