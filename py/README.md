...
The Python SDK for the Peremen API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/peremen-sdk/releases)) or
...
```
py/
├── peremen_sdk.py         -- Main SDK module
