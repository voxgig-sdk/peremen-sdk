...
from peremen_sdk.utility import register

# Load features
from peremen_sdk.feature.base_feature import PeremenBaseFeature
from peremen_sdk.features import _has_feature, _make_feature
...
class PeremenSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PeremenUtility()
        self._utility = utility

        from peremen_sdk.config import shared_config
    ...
    def get_utility(self):
        return PeremenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PeremenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Authentication(self, data=None) -> "AuthenticationEntity":
        ...
        from peremen_sdk.entity.authentication_entity import AuthenticationEntity
        return AuthenticationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PeremenSDK":
        if sdkopts is None:
            sdkopts = {}
