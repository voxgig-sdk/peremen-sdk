...
from peremen_sdk.core.control import PeremenControl
...
from peremen_sdk.core.helpers import get_ctx_prop, to_map
...
class PeremenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, PeremenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PeremenError(code, msg, self)
